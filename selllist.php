<?php
  ...
  $select= $con->prepare("SELECT * FROM `sell` WHERE `shopname`=?");
...
<html>
  ...
  <body class="sidebar-mini fixed">
          <h1 style="font-family: cursive;color: blue;padding-left: 20px;">Sells table  <a style="float: right;padding-right:20px;font-size:20px;" href="javascript:history.back()">Go back</a></h1>
          <div class="col-md-12">
            <div class="card">
              <div class="card-body">
