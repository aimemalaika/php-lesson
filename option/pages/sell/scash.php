...
<head>
  ...
  <title>IHUZA | Sell on cash</title>
     ...
     <?php } ?>
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="scash"><i class="fa fa-circle-o"></i> Sale cash</a></li>
            <li><a href="scredit"><i class="fa fa-circle-o"></i> Sale credit</a></li>
            <li><a href="sreport"><i class="fa fa-circle-o"></i> Sale report</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
        ...
        <div class="col-md-9" style="width:100%">
          <div class="box box-primary">
            <div class="box-body box-profile">
              <h3 class="profile-username text-center">Sell cash</h3>
            ...
            <form method="post">
              <ul class="list-group list-group-unbordered">
                ...
                <input name="unitprice" type="text" class="form-control" data-inputmask="'alias': 'ip'" data-mask>
                </li>
                <li class="list-group-item">
                ...
                <select name="suppliername" class="form-control select3" style="width: 100%;height: 50px;padding:13px">
                  ...
                  <option value="<?=$affiche['setname']?>"><?=$affiche['setname']?></option>
                  <?php } ?>
                </select>
                </li>
              </ul>

              <button name="sellapu" class="btn btn-primary btn-block"><b>Submit purchase oder</b></button>
            </form>
            </div>
          </div>
      </div>
