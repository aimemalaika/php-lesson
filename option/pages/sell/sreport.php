              ...
              <div class="active tab-pane" id="activity" style="padding:0 15px;">
                <div class="post">
                  <div class="user-block">
                    <center><b class="text-center">Total sell : </b><a class="pull-right"><?=$summ+$summ2?> Product(s)</a></center><br>
                    <ul class="list-group list-group-unbordered">
                    <li class="list-group-item">
                    <b>Sell cash</b> <a class="pull-right"><?=$summ?> Product(s)</a>
                    </li>
                    <li class="list-group-item">
                    <b>Sell credit</b> <a class="pull-right"><?=$summ2?> Product(s)</a>
                    </li>
                  </ul>
                  </div>
                </div>
