...
<head>
  ...
  <title>IHUZA | Purchase on cash</title>
        ...
        <div class="col-md-9" style="width:100%">
          <div class="box box-primary">
            <div class="box-body box-profile">
              <h3 class="profile-username text-center">Purchase cash</h3>
            ...
            <form method="post">
              ...
              <button name="purchasecash" class="btn btn-primary btn-block"><b>Submit purchase oder</b></button>
            </form>
            </div>
          </div>
      </div>
